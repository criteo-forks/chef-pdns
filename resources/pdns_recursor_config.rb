...
property :run_group, String, default: lazy { default_recursor_run_user(node['platform_family']) }
property :run_user, String, default: lazy { default_recursor_run_user(node['platform_family']) }
